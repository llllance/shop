    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trader_no', models.CharField(blank=True, max_length=100, null=True, unique=True, verbose_name='支付订单号')),
                ('pay_type', models.CharField(choices=[('alipay', '支付宝'), ('wechat', '微信')], max_length=10, verbose_name='支付类型')),
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancer', '取消'), ('cancel', '待支付')], max_length=10, verbose_name='支付状态')),
